...
export const FONT_FAMILY_SANS =
  '"Noto Sans", "Noto Sans Math", "Noto Sans Symbols2", "Noto Color Emoji", "Noto Sans CJK JP", "Noto Sans CJK SC", "Noto Sans CJK KR", "Microsoft YaHei", "SimSun", "Apple Color Emoji", "Segoe UI Emoji", sans-serif';
export const FONT_FAMILY_MONO =
  '"Noto Sans Mono", "Noto Sans Math", "Noto Sans", "Noto Color Emoji", monospace';
export const FONT_FAMILY_ICONS =
  '"Font Awesome 6 Free", "Noto Sans", sans-serif';
